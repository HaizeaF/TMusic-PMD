...
public class CustomAdapterAuthor extends RecyclerView.Adapter<CustomAdapterAuthor.MyViewHolder> implements  View.OnClickListener {
    private Context context;
    private ArrayList arrayListId, arrayListAuthorName;
    private View.OnClickListener listener;

    CustomAdapterAuthor(ArrayList arrayListId, ArrayList arrayListAuthorName, Context context, View.OnClickListener listener){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.author_recycle_view_template, parent, false);
